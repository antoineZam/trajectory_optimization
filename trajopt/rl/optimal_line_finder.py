...
def train_and_export(track_path: str, vehicle_cfg_path: str, out_path: str, 
    ...
    def make_env():
        return RacingEnv(track, spec, enable_telemetry=True, enable_curriculum=True)
    ...
    print("     optimal speed, racing line lookahead points") 
    print("  Checkpoint Context (4D): next checkpoint distance & direction,")
    print("     checkpoints remaining for goal-oriented navigation")
    print("  Physical Limits (3D): max steering available, slip angle, traction")
    print("  Temporal Context (4D): previous actions, steering smoothness,")
    print("     velocity changes for control continuity")
    print("  Lookahead (10D): enhanced track geometry preview")
    ...
    print("ADAPTIVE REWARDS & GUIDANCE:")
    print("  - Checkpoint magnetism: Magnetic attraction to next checkpoint")
    print("  - Speed optimization: Encourages optimal racing speeds (15-40 m/s)")
    print("  - Early stages: 2x checkpoint rewards for encouragement") 
    print("  - Progressive difficulty: stricter as agent improves")
    print("  - Automatic graduation: based on success rate thresholds")
    ...
    print("  - Curriculum tracking: stage progress and graduations")
    ...
    print("     Driving School: 200+ episodes, 80% checkpoint success → Graduate")
    print("     Learner's Permit: 300+ episodes, 60% success → Graduate") 
    print("     Provisional License: 400+ episodes, 40% success → Graduate")
